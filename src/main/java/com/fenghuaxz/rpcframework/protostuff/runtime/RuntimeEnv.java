...
import com.fenghuaxz.rpcframework.protostuff.Morph;
...
public final class RuntimeEnv {
     ...
     * Enabling this is useful if you want to retain the actual map request used.
     * <p>
     * If disabled, type metadata will not be included and instead, will be mapped to a default request.
     * <p>
     * <p>
    ...
    private static Method getMethodNewInstanceFromObjectInputStream() {
        try {
            return java.io.ObjectInputStream.class.getDeclaredMethod(
                    "newHandler", Class.class, Class.class);
        } catch (Exception e) {
            return null;
        }
    }
